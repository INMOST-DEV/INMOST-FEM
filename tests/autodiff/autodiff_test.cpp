...
TEST(ElasticityTest, TensorAlgebra){
    using namespace Ani;
    Mtx3D<> grU(
        std::array<double, 9>{
            0.1, 0.2, 0.3,
...
TEST(ElasticityTest, SymAutoDiff) {
    using namespace Ani;
    Mtx3D<> grU(
        std::array<double, 9>{
            0.1, 0.2, 0.3,
    ...
    auto to_short_str = [](const SymMtx3D<>& a) { 
    ...
    auto to_short_str1 = [](const BiSym4Tensor3D<>& a) { 
        std::ostringstream oss;
        oss << "{ " << std::scientific << std::setprecision(16);
        for (std::size_t i = 0; i < a.continuous_size(); ++i)
            oss << (abs(a[i]) > 1e-100 ? a[i] : 0.0) << ", ";
    ...
    test_invariants(1);
    test_invariants(2);
    auto test_operations = [E, to_short_str, to_short_str1](unsigned char dif){
        auto J = Mech::J<>{dif, E};
        auto I1 = Mech::I1<>{dif, E};
        auto V0 = J * I1;
        ...
        BiSym4Tensor3D<> ddV0(std::array<double, 21>{{ -6.4647879564282533e+00, 1.8956599577232378e+00, -1.0795250075621336e+01, 
        ...
        BiSym4Tensor3D<> ddV1(std::array<double, 21>{{ -2.2951502963362074e+01, 4.1581558728448318e+00, 1.5625716088362072e+01, 
        ...
        BiSym4Tensor3D<> ddV2(std::array<double, 21>{{ 1.7820929492281490e+00, -3.2286427057162537e-01, -3.8344720644008428e+00, 
        ...
        BiSym4Tensor3D<> ddV3(std::array<double, 21>{{ 2.2951502963362074e+01, -4.1581558728448318e+00, -9.9207160883620720e+00, 
        ...
        BiSym4Tensor3D<> ddV4(std::array<double, 21>{{ -2.3879528306679698e-03, 1.0839229001194004e-03, -1.5322288751658639e-03, 
        ...
        BiSym4Tensor3D<> ddV5(std::array<double, 21>{{ 2.0049526447205781e+00, -3.7835165993928682e-01, 1.5588808773460410e+00, 
        ...
        BiSym4Tensor3D<> ddV6(std::array<double, 21>{{ 1.2878026768867452e+01, -2.3446686562310135e+00, -9.6799115620957448e+00, 
        ...
        BiSym4Tensor3D<> ddV7(std::array<double, 21>{{ -7.5261386462459812e-01, 1.3635210583676702e-01, -3.4695922318643313e-01, 
        ...
        BiSym4Tensor3D<> ddV8(std::array<double, 21>{{ 3.3384596709684095e-03, 3.0552770815221378e-04, 3.9416922099284727e-04, 
        ...
        BiSym4Tensor3D<> ddV10(std::array<double, 21>{{ -2.1600521920322407e+02, 3.9133967489136069e+01, -2.0251261684559658e+01, 
        ...
        BiSym4Tensor3D<> ddV11(std::array<double, 21>{{ -1.1514031403834240e+00, 2.0860131634255222e-01, -3.5737393970027675e-01, 
        ...
        BiSym4Tensor3D<> ddV12(std::array<double, 21>{{ 4.9558448521328181e+01, -8.9785733900300695e+00, -2.0466996028476805e+00, 
        ...
        SymMtx3D<> dV13(std::array<double, 6>{{ -4.9278080051604238e+00, 8.9277786424789340e-01, 1.6577124881175664e+00, 
                                            -3.6784147861732905e+00, 1.9311057888709877e+00, -3.6274191445819772e+00,  }});
        BiSym4Tensor3D<> ddV13(std::array<double, 21>{{ -4.9558448521328188e+01, 8.9785733900300748e+00, 2.0466996028476805e+00, 
                1.6671440713498896e+01, -5.3512496129072806e+00, -2.4017213371103363e+00, -4.4340152480834966e+01, 
                6.7021517644442952e+00, 1.5760579009791709e+01, -2.7614141363460071e+01, 2.4082651271042089e+01, 
                -5.1765189946750443e+00, -7.8982268169510093e+00, 1.4496958973230740e+01, -5.5727652058651120e+00, 
                -4.2893662332156694e+01, 9.3393062974060825e+00, 1.2272049387593908e+01, -3.1307101199704821e+01, 
        ...
        BiSym4Tensor3D<> ddV14(std::array<double, 21>{{ 6.0220854905365089e+00, -1.0910296458241142e+00, -4.9645900124286033e+00, 
        ...
        BiSym4Tensor3D<> ddV15(std::array<double, 21>{{ 6.9196298412582271e+00, -1.2536390104068995e+00, -4.7153215496671423e+00, 
        ...
        BiSym4Tensor3D<> ddV16(std::array<double, 21>{{ -8.1198282462643345e-01, 1.4710806330458068e-01, -1.5086633897318186e-01, 
        ...
        BiSym4Tensor3D<> ddV17(std::array<double, 21>{{ 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 
        ...
        SymMtx3D<> dV18(std::array<double, 6>{{ 1.9992816091954024e+00, -3.6221264367816119e-01, -6.7255747126436760e-01, 
                                            1.4923850574712652e+00, -7.8347701149425264e-01, 1.4716954022988502e+00,  }});
        BiSym4Tensor3D<> ddV18(std::array<double, 21>{{ -2.0883630892721823e+00, 3.7835165993928688e-01, -1.5588808773460410e+00, 
        ...
        BiSym4Tensor3D<> ddV19(std::array<double, 21>{{ 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 
                0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 
                0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 
                0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 
                0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 0.0000000000000000e+00, 
        ...
        BiSym4Tensor3D<> ddV20(std::array<double, 21>{{ 5.5444963401071300e+03, -7.9069738112428922e+02, -3.7381625145402211e+02, 
        ...
        BiSym4Tensor3D<> ddV21(std::array<double, 21>{{ -4.1307360492796263e-01, 7.0004816092794325e-02, -2.1043844836839073e-01, 
        ...
        BiSym4Tensor3D<> ddV22(std::array<double, 21>{{ -2.8578399470700633e-01, 3.3043819633249934e-02, -3.9832364103735962e-01, 
    ...
    auto test_fung_potential = [get_fung_potential, E](unsigned char dif){
        ...
        if (dif >= 2){
            BiSym4Tensor3D<> ddW(std::array<double, 21>{3.6739898255357202e+06, -2.0532925321687417e+05, 2.4447791077594794e+06, 
