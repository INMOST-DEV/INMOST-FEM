...
|обогащение пространства, +| `FemUnionT<P1Fem, B4Fem>` | `P1 + B4` |
|L2 ортог. дополнение, -| недоступно | `P2 - P1` |
|энергетич. ортог. дополнение| недоступно| `makeEnergyComplement(P2, P1) `|
